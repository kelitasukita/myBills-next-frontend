      ...
      <div className="flex flex-col bg-white">
        ...
        <article className="p-6">
          ...
          <form action="/" className="flex flex-col mt-12">
            ...
            <input className="heading-s text-gray-800 border border-gray-300 h-12 rounded-md p-4 mb-6" type="text" />

            <label className="body-variant text-gray-400 mb-4  ">Currency</label>
            <div className="flex justify-start items-center mb-8">
              <input className="heading-s text-gray-800 appearance-none rounded-full checked:bg-violet-600 border border-gray-300 h-5 w-5 mr-1 " type="radio" name="currency" />
              <label>EUR</label>
              <input className="heading-s text-gray-800 appearance-none rounded-full checked:bg-violet-600 border border-gray-300 h-5 w-5 mr-1 ml-4" type="radio" name="currency" />
              <label>BRL</label>
              <input className="heading-s text-gray-800 appearance-none rounded-full checked:bg-violet-600 border border-gray-300 h-5 w-5 mr-1 ml-4" type="radio" name="currency" />
              <label>USD</label>
            </div>
            ...
            <input className="heading-s text-gray-800 border border-gray-300 h-12 rounded-md p-4 mb-6" type="number" />
            ...
            <div className="flex justify-start items-center">
              <input className="heading-s text-gray-800 border border-gray-300 h-12 w-20 rounded-md p-4 mb-6" type="number" />
