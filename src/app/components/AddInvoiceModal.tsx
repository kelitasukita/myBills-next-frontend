...
export default function AddInvoiceModal({ isOpen, setModalClose }) {

  if (isOpen) {

    return (
      <div className="lg:flex bg-black bg-opacity-50 lg:top-0 top-18 left-0 lg:left-24 w-screen h-screen z-40 lg:overflow-auto">
