    ...
    <>
      ...
      <article className="flex justify-between items-center w-11/12 mx-auto mt-8 sm:mt-16 lg:mt-20 lg:w-full">
        ...
        <div className="flex justify-center items-center">
          ...
          <div>
            <div>
              <div className="cursor-pointer flex justify-end items-center w-90 bg-violet-500 hover:bg-violet-400 hover:transition hover:duration-400 rounded-full p-1.5" onClick={handleModal}>
