...
export default function InvoiceItem({ invoice }: { invoice: InvoiceProps }) {
  ...
  return (
    <article className="cursor-pointer grid grid-cols-3 grid-rows-3 mt-5 w-11/12 mx-auto h-32 p-6 bg-white rounded-lg shadow-md hover:border hover:border-violet-600 hover:border-solid md:grid md:grid-cols-5 md:grid-rows-1 md:h-18 md:justify-center md:items-center lg:w-full">
